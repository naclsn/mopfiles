...
#define push(__a) ((__a)->len < (__a)->cap || (((__a)->cap || !(__a)->ptr) && ((__a)->ptr = realloc((__a)->ptr, ((__a)->cap+= (__a)->cap+8)*sizeof*(__a)->ptr))) ? (__a)->ptr+(__a)->len++ : (OOM))
...
#define _dyarr_inline_ns(__fname) _##__fname

#if __STDC_VERSION__ < 199901L
#define inline
#endif

static inline bool  _dyarr_inline_ns(dyarr_resize)(void** ptr, size_t isz, size_t* cap, size_t rsz);
static inline void* _dyarr_inline_ns(dyarr_insert)(void** ptr, size_t isz, size_t* cap, size_t* len, size_t k, size_t n);
static inline void  _dyarr_inline_ns(dyarr_remove)(void** ptr, size_t isz, size_t* len, size_t k, size_t n);
static inline void* _dyarr_inline_ns(dyarr_replace)(void** ptr, size_t isz, size_t* cap, size_t* len, size_t k, size_t n, void* spt, size_t sln);
static inline int   _dyarr_inline_ns(dyarr_cmp)(void** s1, size_t z1, void** s2, size_t z2);
...
bool _dyarr_inline_ns(dyarr_resize)(void** ptr, size_t isz, size_t* cap, size_t rsz) {
    void* niw = realloc(*ptr, rsz * isz);
    return niw ? *ptr = niw, *cap = rsz, true : false;
}

void* _dyarr_inline_ns(dyarr_insert)(void** ptr, size_t isz, size_t* cap, size_t* len, size_t k, size_t n) {
    size_t nln = *len+n;
    if (*cap < nln && !_dyarr_inline_ns(dyarr_resize)(ptr, isz, cap, nln)) return NULL;
    memmove(*(char**)ptr+(k+n)*isz, *(char**)ptr+k*isz, (*len-k)*isz);
    *len = nln;
    return *(char**)ptr+k*isz;
}

void _dyarr_inline_ns(dyarr_remove)(void** ptr, size_t isz, size_t* len, size_t k, size_t n) {
    memmove(*(char**)ptr+k*isz, *(char**)ptr+(k+n)*isz, ((*len-= n)-k)*isz);
}

void* _dyarr_inline_ns(dyarr_replace)(void** ptr, size_t isz, size_t* cap, size_t* len, size_t k, size_t n, void* spt, size_t sln) {
    size_t nln = *len+sln-n;
    if (n < sln && *cap < nln && !_dyarr_inline_ns(dyarr_resize)(ptr, isz, cap, nln)) return NULL;
...
int _dyarr_inline_ns(dyarr_cmp)(void** s1, size_t z1, void** s2, size_t z2) {
    int d = z1-z2;
